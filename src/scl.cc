...
struct toplevel_parse_inner : pctx::Any<table_parse, table_array_parse>
{
...
struct toplevel_parse : pctx::Repeat<toplevel_parse_inner, false>
{
  pctx::empty_t operator()(State&, std::span<pctx::empty_t>) const
  {
    return {};
  };
};

using parser = pctx::Parser<toplevel_parse>;
